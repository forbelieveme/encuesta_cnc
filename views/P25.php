    ...
    <div class="col-xl-6 offset-xl-3 col-lg-6 offset-lg-3 col-md-8 offset-md-2">
        ...
        <form method = 'POST' id="form_P25" onsubmit="return false;">    
            ...
            <div class = "form-group mt-5" id = "P25_2">
                <div class = "container" >
                    <h5>Atención del personal en el ingreso a la feria </h5>
                    <div class = " form-check-inline col-1">
                        <?php 
                        for ($counter = 1; $counter < 11; $counter++){
                            echo "<div  class = 'radioboton col-5 col-sm-1'>";                        
            ...
            <div class = "form-group mt-5" id = "P25_3">
                <div class = "container" >
                    <h5>Aseo en baños y exteriores </h5>
                    <div class = " form-check-inline col-1">
            ...
            <div class = "form-group mt-5" id = "P25_4">
                <div class = "container" >
                    <h5>Aseo al interior de los pabellones </h5>
                    <div class = " form-check-inline col-1">
                        <?php 
                        for ($counter = 1; $counter < 11; $counter++){
                            echo "<div  class = 'radioboton col-5 col-sm-1'>";                        
            ...
            <div class = "form-group mt-5" id = "P25_5">
                <div class = "container" >
                    <h5>Atención y amabilidad del Personal de Seguridad 
                    y vigilancia </h5>
                    <div class = " form-check-inline col-1">
                        <?php 
                        for ($counter = 1; $counter < 11; $counter++){
            ...
            <div class = "form-group mt-5">                                          
                ...
                onclick = "
                submit_decision(true, 5, 'escala', 'p25',
