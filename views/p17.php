            ...
            <div class="form-group">
                ...
                <div class="container">
                    ...
                    for ($counter = 1; $counter < 11; $counter++) {
                        ...
                        echo "<input class='form-check-input' type='radio' name='P17' id='P17_" . $counter . "' value='" . $counter . "'>";
                        echo "<label class='form-check-label escala' for='inlineRadio17'>" . $counter . "</label>";
                        echo "</div";
                    }
                    ?>
                </div>
